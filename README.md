...
1.Customer Performance Assessment: Developed an in-depth for evaluating customer performance.

2.Market Performance Comparison: Conducted a comprehensive analysis to compare with sales targets.
...
1.Profit and Loss (P&L) Reports: Created P&L statement 

2.P&L Reports by Markets: Generated P&L reports categorized by different.
